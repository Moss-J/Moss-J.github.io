...
The following are some animations generated on the test map. There are 3 players in total, and there are 3 benchmarks(Player Selection, Decision Tree, Toward Center) for each player.
