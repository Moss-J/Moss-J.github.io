...
According to the CV results, we created 3 models of different distance range for each player, and resulting Hyper-Parameters(inputing features, criterion) that the models should use.
