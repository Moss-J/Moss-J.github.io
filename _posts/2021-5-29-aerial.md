...
According to the distance from the settlement center, we created 3 models for each player, and defined the input values and parameters (criterion) that the models should use 
